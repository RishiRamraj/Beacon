...
COURTYARD = {
  ...
  { tx = 79, ty = 486, room = 0x71, level = 0, gate = {"keys"}, done = {"tile_outside", 0xF0, 0xFF},
...
SANCTUARY = {
  ...
  { tx = 91, ty = 326, room = 0x51, level = 0, push = 6, track = 0xEE, track_dx = -2, track_dy = 2, done = {"pushed"},
  ...
  { tx = 176, ty = 218, room = 0x32, level = 0, done = {"tile_outside", 0x58, 0x5D},
  ...
  { tx = 159, ty = 197, room = 0x32, level = 0, gate = {"any", {"tile_outside", 0xF0, 0xFF}, {"keys"}},
  ...
  { tx = 111, ty = 133, room = 0x21, level = 0, gate = {"any", {"tile_outside", 0xF0, 0xFF}, {"keys"}},
  ...
  { tx = 111, ty = 76, room = 0x11, level = 0, push = 0, done = {"tile_outside", 0x70, 0x7F},
