...
SANCTUARY = {
  ...
  { tx = 156, ty = 74, room = 0x12, level = 0, kind = "chest", via = true,
    note = "The Sanctuary chest, a 2x2 at 156-157,74-75, named by its top-left tile as the other chest steps are. kind chest retires it once the tile stops reading as a chest, which is the game rewriting it on opening. via because the door step below sits later in the chain, and the driver picks the furthest reachable step in a room: without it the door wins and the guide walks straight past the chest." },
